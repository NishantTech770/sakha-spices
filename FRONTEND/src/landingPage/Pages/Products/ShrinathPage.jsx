...
const PRODUCTS = [
  ...
  },
  {
    ...
    category: "Salt",
    name: "Sendha Namak Premium Pack",
    badge: null,
    ...
    <div className="shrinath-page page-content">
      <section className="shrinath-header">
        ...
        <div className="shrinath-header__inner">
          ...
          <p className="shrinath-header__eyebrow">
            Shyam Sakha Industries Pvt. Ltd. &nbsp;·&nbsp; Traditional Blends
          </p>

          <h1 className="shrinath-header__title">Shrinath Ji</h1>
          <p className="shrinath-header__subtitle">
            Where Tradition Meets Pure Aroma
          </p>
              ...
              >
                <div className="shrinath-card__img-wrap">
                  <img
                    src={p.img}
                    alt={p.name}
                    className="shrinath-card__img"
                  />
                  <div className="shrinath-card__img-overlay" />
                  {p.badge && (
                    <span className="shrinath-card__badge">{p.badge}</span>
                  )}
                </div>
                <div className="shrinath-card__body">
                  ...
                  <div className="shrinath-card__footer">
                    <div className="shrinath-card__sizes">
                      {p.sizes.map((s) => (
                        <span className="shrinath-card__size" key={s}>
                          {s}
                        </span>
                      ))}
                    </div>
      ...
      <section className="shrinath-banner">
        <div className="shrinath-banner__inner">
          ...
          <p className="shrinath-banner__text">
            Every Shrinath Ji blend honours recipes passed down through
            generations. For bulk orders, retail partnerships or export
            enquiries — let's connect.
          </p>
