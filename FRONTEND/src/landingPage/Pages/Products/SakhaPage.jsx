...
const PRODUCTS = [
  ...
  },
  {
    ...
    category: "Blend",
    name: "Sakha Kitchen King Masala",
    badge: "New",
            ...
            {filtered.map((p, i) => (
              ...
              >
                <div className="sakha-card__img-wrap">
                  ...
                  {p.badge && (
                    <span className="sakha-card__badge">{p.badge}</span>
                  )}
                ...
                <div className="sakha-card__body">
                  ...
                  <div className="sakha-card__footer">
                    <div className="sakha-card__sizes">
                      {p.sizes.map((s) => (
                        <span className="sakha-card__size" key={s}>
                          {s}
                        </span>
                      ))}
                    </div>
