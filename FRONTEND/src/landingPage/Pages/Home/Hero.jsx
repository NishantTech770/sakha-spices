...
const IMGS = {
  ...
  prod2:
    "https://images.openai.com/static-rsc-3/_m3VY1RH0wvRkCxjhtQyr2Kutr8pCok_WGEnFHUSwHp5JazXGK0e-pya3QJ6W_JIDI4VUfmQ5MrCQw8frRzIt0U8OuSxaEnrayI4lXMOR-k?purpose=inline",
  prod3:
    "https://images.openai.com/static-rsc-3/t9LqSTAQWZE2BFD44cQ1bZ7c2CrViFKx4D0wsgiNvmLp_IG5NW4k-R0BwPNHnsRC5TcQiMItT2XqkCKuhnKWhWFtv-cDlEI8jFr7p8sMqa0?purpose=inline",
  prod4:
...
const PROCESS_STEPS = [
  {
    ...
    desc: "We partner directly with verified farmers across Rajasthan, Kerala and Gujarat to ensure origin-authentic produce.",
  },
  {
    icon: "🤝",
    num: "02",
    title: "Direct Farm Procurement",
    desc: "Spices are procured straight from farms — no middlemen, no compromise on freshness or traceability.",
  },
  {
    icon: "🔍",
    num: "03",
    title: "Raw Material Inspection",
    desc: "Every incoming batch undergoes rigorous sampling and lab-grade inspection before entering our facility.",
  },
  {
    icon: "🧹",
    num: "04",
    title: "Cleaning & Dust Removal",
    desc: "Multi-stage mechanical cleaning removes dust, foreign particles and impurities with precision machinery.",
  },
  {
    icon: "⚖️",
    num: "05",
    title: "Sorting & Grade Segregation",
    desc: "Spices are sorted by size, colour and quality grade to ensure only the finest move to the next stage.",
  },
  {
    icon: "☀️",
    num: "06",
    title: "Drying & Moisture Control",
    desc: "Controlled drying brings moisture to optimal levels, preserving aroma and preventing microbial growth.",
  },
  {
    icon: "🧪",
    num: "07",
    title: "Quality Testing & Batch Approval",
    desc: "Each batch is tested for colour value, aroma potency and purity before it receives our QC approval stamp.",
  },
  {
    icon: "📦",
    num: "08",
    title: "Hygienic Packing & Sealing",
    desc: "Nitrogen-flushed, food-grade packing in our hygiene-controlled facility locks freshness at its peak.",
  },
  {
    icon: "🏭",
    num: "09",
    title: "Warehouse Storage",
    desc: "Finished goods are stored in temperature and humidity-controlled warehouses to maintain shelf quality.",
  },
  {
    icon: "🚚",
    num: "10",
    title: "Branded Dispatch",
    desc: "Orders are dispatched under the Sakha or Shrinath Ji brand, ready for retail shelves across India.",
  },
];
      ...
      <section className="hero">
        <div className="hero__left">
          ...
          <p className="hero__desc">
            ...
            used, grown in India's finest farms and ground fresh for your
            kitchen.
          </p>
      ...
      <section className="legacy">
        <div className="legacy__inner">
          ...
          <div className="legacy__content">
            ...
            <p className="legacy__text">
              <strong>Sakha</strong> delivers everyday staples with premium
              quality.
              <strong> Shrinath Ji</strong> honours sacred tradition through
              blends crafted from age-old Rajasthani recipes.
            </p>
        ...
        <div className="process__inner">
          <div className="process__header">
            ...
            <h2 className="process__title">
              Our <em>Manufacturing</em>
              <br />
              Process
            </h2>
            <p className="process__sub">
              Every packet you open has travelled through a precise 10-step
              journey — from a farmer's field to your kitchen shelf.
            </p>
          </div>
      ...
      <section className="cta-banner">
        ...
        <div className="cta-banner__content">
          ...
          <p className="cta-banner__text">
            Whether you're a home cook or a business buyer, we'd love to hear
            from you. Reach out and let's bring authentic flavour to your table.
          </p>
