...
const IMGS = {
  hero: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=1600&q=80",
  feat: "https://images.unsplash.com/photo-1509358271058-acd22cc93898?w=1000&q=80",
  b1: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=700&q=80",
  b2: "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=700&q=80",
  ...
  b5: "https://images.unsplash.com/photo-1540420773420-3366772f4999?w=700&q=80",
  b6: "https://images.unsplash.com/photo-1472476443507-c7a5948772fc?w=700&q=80",
};
...
const FEATURED = {
  ...
  excerpt:
    "Most turmeric sold today is high-heat milled, stripping away the volatile oils that give it colour, aroma and its celebrated health benefits. We break down exactly what stone-grinding preserves — and why it matters for your kitchen.",
};
...
const BLOGS = [
  {
    ...
    excerpt:
      "A behind-the-scenes look at how Shyam Sakha Industries builds direct relationships with farmers to guarantee freshness and traceability in every batch.",
    author: "Sakha Team",
    init: "ST",
  },
  {
    ...
    excerpt:
      "Byadgi, Kashmiri, Teja — India grows dozens of chilli varieties. We explain the differences in heat, colour and flavour to help you pick the right one.",
    author: "Sakha Team",
    init: "ST",
  },
  {
    ...
    excerpt:
      "Every ingredient in our Shrinath Ji blend carries a story rooted in Rajasthani tradition. Here's what goes in, why it goes in, and how it's slow-roasted.",
    author: "Sakha Team",
    init: "ST",
  },
  {
    ...
    excerpt:
      "We walk through the lab tests, moisture controls and packaging standards that make a spice batch export-ready — and why those same standards benefit you.",
    author: "Sakha Team",
    init: "ST",
  },
  {
    ...
    excerpt:
      "Long before they flavoured food, spices like haldi, jeera and ajwain were prescribed as remedies. A look at the ancient science behind everyday ingredients.",
    author: "Sakha Team",
    init: "ST",
  },
  {
    ...
    excerpt:
      "Faded colour, flat aroma, dull flavour — your spices are trying to tell you something. Here's how to spot degraded spices and store them properly.",
    author: "Sakha Team",
    init: "ST",
  },
];
      ...
      <section className="blogs-newsletter">
        <div className="blogs-newsletter__inner">
          ...
          <p className="blogs-newsletter__text">
            Get new articles about spices, recipes and quality tips delivered to
            your inbox — no spam, just pure flavour.
          </p>
